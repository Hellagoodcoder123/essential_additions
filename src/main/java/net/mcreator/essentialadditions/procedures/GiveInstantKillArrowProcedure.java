...
public class GiveInstantKillArrowProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof ServerLevel _level)
			_level.getServer().getCommands().performCommand(
					...
					"give @p tipped_arrow{CustomPotionEffects:[{Id:6,Amplifier:9}],display:{Name:\"{\\\"text\\\":\\\"Instant Kill Arrow\\\",\\\"color\\\":\\\"dark_red\\\",\\\"bold\\\":\\\"false\\\",\\\"italic\\\":\\\"false\\\"}\"}}");
