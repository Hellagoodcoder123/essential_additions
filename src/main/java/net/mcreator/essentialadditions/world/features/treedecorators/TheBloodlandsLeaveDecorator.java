...
public class TheBloodlandsLeaveDecorator extends LeaveVineDecorator {
	public static final TheBloodlandsLeaveDecorator INSTANCE = new TheBloodlandsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("the_bloodlands_tree_leave_decorator");
