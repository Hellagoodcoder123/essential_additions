package net.mcreator.essentialadditions.block.entity;
...
public class RefundStationBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(4, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public RefundStationBlockEntity(BlockPos position, BlockState state) {
		super(EssentialAdditionsModBlockEntities.REFUND_STATION.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("refund_station");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new RefundStationGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return new TextComponent("Refund Station");
	}
